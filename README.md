...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/Cam-Hack/blob/main/20250713_000411.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/Cam-Hack
    $ cd Cam-Hack 
    $ python Saiko.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/Cam-Hack && cd Cam-Hack && python Saiko.py
 ### Hi there 👋
